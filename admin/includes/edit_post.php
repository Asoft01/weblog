...
if (isset($_POST['update_post'])) {
            ...
            $query .= "WHERE post_id= {$query_id} ";

            $update_post= mysqli_query($connection, $query);
            confirm($update_post);
            echo "<p class='bg-success'>Post Updated! <a href='../post.php?p_id={$query_id}'>View Post</a> or <a href='posts.php'>View All Post</a></p>";
...
<body>
 ...
 -->
    ...
    <div class="form-group">
      ...
      <textarea class="form-control" name="post_content" id="" cols="10" rows="10" readonly="enabled">
