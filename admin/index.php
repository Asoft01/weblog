...
<?php 
$post_count= count_records(get_all_users_post());
                    ...
                    <div class="col-xs-9 text-right">
                      <?php    
                        ...
                        */
                        ...
                        // $post_count= get_all_users_post();
                        ?>

                       <!-- div class='huge'><?php //echo $post_count=get_all_users_post();?></div>; -->
    ...
    ?>
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ...
            <?php
                $element_text= ['All Post','Active Posts', 'Draft Posts', 'Approved Comments', 'Pending Comments', 'Comments', 'Categories'];
                $element_count= [$post_count, $post_published_count, $post_draft_count, $approved_comment_count, $unapproved_comment_count, $comment_count, $category_count];
